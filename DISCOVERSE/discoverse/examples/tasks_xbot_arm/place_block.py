...
from discoverse.task_base.xbot_arm_task_base import XbotArmTaskBase, recoder_xbot_arm, PyavImageEncoder
from discoverse.task_base import copypy2, batch_encode_videos

class SimNode(XbotArmTaskBase):
...
if __name__ == "__main__":
    ...
    # 调试，待删
    # print("qpos:", sim_node.mj_data.qpos)
    # print("qvel:", sim_node.mj_data.qvel)
    # print("ctrl:", sim_node.mj_data.ctrl)
    # sim_node.mj_data.ctrl[:] = 0
    ...
    tmat_armbase_2_world = np.linalg.inv(get_body_tmat(sim_node.mj_data, "arm_pose"))
    ...
    while sim_node.running:
        ...
        if stm.state_idx >= stm.max_state_cnt:
            if sim_node.check_success():
                recoder_xbot_arm(save_path, act_lst, obs_lst, cfg)
