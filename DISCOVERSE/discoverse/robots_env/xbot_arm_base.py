...
class XbotArmCfg(BaseConfig):
    mjcf_file_path = "mjcf/xbot_arm_floor.xml"
    decimation     = 4
    timestep       = 0.005
    sync           = True
    headless       = False
    ...
    obs_rgb_cam_id  = None
    rb_link_list   = ["base_link", "arm_1_link", "arm_2_link", "arm_3_link", "arm_4_link", "arm_5_link", "arm_6_link", "gripper_1_link", "gripper_2_link"]
    obj_list       = []
    use_gaussian_renderer = False
    gs_model_dict = {
        "base_link"  : "xbot_arm/base_link.ply",
        "arm_1_link"     : "xbot_arm/arm_1_link.ply",
        "arm_2_link"     : "xbot_arm/arm_2_link.ply",
        "arm_3_link"     : "xbot_arm/arm_3_link.ply",
        "arm_4_link"     : "xbot_arm/arm_4_link.ply",
        "arm_5_link"     : "xbot_arm/arm_5_link.ply",
        "arm_6_link"     : "xbot_arm/arm_6_link.ply",
        "gripper_1_link"      : "xbot_arm/gripper_1_link.ply",
        "gripper_2_link"      : "xbot_arm/gripper_2_link.ply",
    }

class XbotArmBase(SimulatorBase):
    def __init__(self, config: XbotArmCfg):
        self.nj = 7
